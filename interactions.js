$(document).ready(function () {
  ...
  $(".obliterate").click(function (e) {
    ...
    // Set the content for the .display-info element for the 'Body' work
    var infoTitle = "1984 (Obliteration)";
    var infoDescription =
  ...
  $(".manicule").click(function (e) {
    ...
    var infoDescription =
      "As a fourth year graphic design student I am frustrated with the forceful imposition of homogenization in design in the contemporary era, especially by the industry standard tools like the creative cloud. For this reason, I constantly strive to develop tools that support an unpredictable, unconventional, and imperfect design process—against the ideal of the perfect, efficient twenty-first century. <br><br> Following those ideas I have decided to create a prosthetic extension and a software that would use this prosthetic extension in order to create designs. The way this tool works is each finger has a different functionality. By pinching your index and thumb you generate a rectangle and the software, using ml5.js – hand tracking machine learning library, calculates the distance between your index and thumb as well as the location of your hand on the p5 canvas. Therefore you can change its position, size and manipulate the content inside the rectangle. By pinching your thumb and middle finger you toggle between states of having text inside the rectangle, an image or just having an empty rectangle. By using your ring finger you place the rectangle at its last location with its desired scale. Finally, the pinky to undo all the progress. <br><br> I have built the tool using hose clamps, wires, a bracelet, and light hooks. The brutalist structure of the hand where the wires are organized yet exposed, makes you feel like part of the machine.`";
    var mediaItems = [
      {
        type: "image",
